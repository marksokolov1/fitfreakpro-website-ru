...
<main id="main" class="home-page">
      ...
      <section class="hero redesign-hero">
        <div class="container hero-grid">
          <div class="hero-copy-wrap">
            ...
            <p class="hero-differentiator">Платформа поддерживает вашу методику, а не заменяет ее.</p>
          </div>
      ...
      <section class="section core-features home-band home-band-muted" id="core-features">
      ...
      <section class="section feature-split home-feature home-feature-primary" id="features">
        ...
        <div class="container split-panel">
          ...
          <figure class="app-ui-frame"><img src="{{ asset('assets/img/app-screen-2.webp') }}" width="619" height="1100" alt="Экран библиотеки видео упражнений FitFreak Pro" loading="lazy" /></figure>
        </div>
      </section>
      ...
      <section class="section feature-split home-feature home-feature-client" id="client-process">
        <div class="container split-panel reverse">
          <figure class="app-ui-frame"><img src="{{ asset('assets/img/app-screen-7.webp') }}" width="619" height="1100" alt="Клиентский экран с питанием и текущей тренировкой" loading="lazy" /></figure>
      ...
      <section class="section feature-split home-feature home-secondary-feature" id="coach-calendar">
        <div class="container split-panel reverse">
          <figure class="app-ui-frame app-ui-frame-compact"><img src="{{ asset('assets/img/app-screen-11.webp') }}" width="619" height="1100" alt="Календарь тренера с блоками расписания в FitFreak Pro" loading="lazy" /></figure>
