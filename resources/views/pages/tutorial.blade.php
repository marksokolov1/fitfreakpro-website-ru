...
<main id="main">
        ...
        <div class="container tutorial-hero-grid">
          <div class="tutorial-hero-copy">
            ...
            <div class="cta-actions">
              <a class="btn btn-primary" href="#coach-guide">Я тренер</a>
              <a class="btn btn-secondary" href="#client-guide">Я клиент</a>
            </div>
          </div>
          <figure class="tutorial-hero-shot">
      ...
      <div class="tutorial-switch" aria-label="Быстрая навигация по инструкции">
        <div class="container tutorial-switch-inner">
          <a href="#coach-guide">Для тренера</a>
          <a href="#client-guide">Для клиента</a>
        </div>
      </div>
      <section class="section tutorial-guide" id="coach-guide">
        <div class="container tutorial-guide-header">
          <div class="eyebrow">Для тренера</div>
          <h2>Начните работать с клиентами</h2>
          <p>Создайте бесплатный аккаунт тренера, подготовьте собственную библиотеку упражнений и организуйте работу с клиентами в одном приложении.</p>
        </div>
        <div class="container tutorial-steps">
          <article class="tutorial-step">
            ...
            <figure class="tutorial-shot-card">
      ...
      <section class="section tutorial-guide" id="client-guide">
        <div class="container tutorial-guide-header">
          <div class="eyebrow">Для клиента</div>
          <h2>Следуйте плану своего тренера</h2>
          <p>Подключитесь к тренеру по коду приглашения, активируйте доступ и используйте приложение для тренировок, питания и фиксации прогресса.</p>
        </div>
        <div class="container tutorial-steps">
          <article class="tutorial-step">
            <div class="tutorial-step-copy">
          ...
          <article class="tutorial-step tutorial-step-copy-only">
            <div class="tutorial-step-copy">
              <span class="tutorial-step-number">03</span>
