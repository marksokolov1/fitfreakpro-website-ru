...
| `/pricing/` | `pricing/index.html` | indexable | Цены FitFreak Pro для тренеров и клиентов | Аккаунт тренера — 0 ₽. Доступ клиента — 990 ₽ за 30 дней. Оплата через ЮKassa. | `https://fitfreakpro.ru/pricing/` | Тренер работает бесплатно. Клиент оплачивает цифровое сопровождение. | WebPage, BreadcrumbList | 9 |
